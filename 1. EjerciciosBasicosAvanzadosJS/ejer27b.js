...
// Variables para guardar el "campeón actual"
...
for (const cartoon of cartoons) {
  ...
  if (cartoon.debut < anoMasAntiguo) {
    // Este se convierte en el nuevo "campeón"
    nombreMasAntiguo = cartoon.name;
    anoMasAntiguo = cartoon.debut;
  }
}


console.log(nombreMasAntiguo);