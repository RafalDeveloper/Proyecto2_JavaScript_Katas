...
const suma = exams.reduce((acumulador, sumas) => acumulador + sumas.score, 0);
...
const sumaAprobados = exams
  .filter((nota) => nota.score > 5)
  .reduce((acumulado, suma) => acumulado + suma.score, 0);
...
const mediaNotas = exams.reduce((acumulador,sumas) => acumulador+ sumas.score,0)
console.log("Ejercicio 3:");
console.log(mediaNotas / exams.length);