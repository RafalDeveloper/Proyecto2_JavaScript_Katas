...
input.addEventListener("input", (eventtInput) => {
  if (input === eventtInput) {
    const inputInput = streamers.filter((streamer) =>
      inputInput.includes(input),
    );
    console.log(eventtInput);
  }
});
